	...
	<xsl:template name="add-metadata">
		...
		<xsl:element name="head">
			...
			<xsl:element name="link">
				...
				<xsl:attribute name="href">https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css</xsl:attribute>
				<xsl:attribute name="integrity">sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T</xsl:attribute>
